...
#SBATCH --job-name=EIFT_AAAI_SEE-v1
#SBATCH --output=./logs/SeeEverythingEverytime/EIFT_AAAI/EIFT_AAAI_SEE-v1/%j-job.out # slurm的输出文件，%j是jobid
#SBATCH --error=./logs/SeeEverythingEverytime/EIFT_AAAI/EIFT_AAAI_SEE-v1/%j-job.err # 指定错误输出的格式
