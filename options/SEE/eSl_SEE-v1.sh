...
#SBATCH --output=./logs/SeeEverythingEverytime/eSL/eSl_SEE-v1/%j-job.out # slurm的输出文件，%j是jobid
#SBATCH --error=./logs/SeeEverythingEverytime/eSL/eSl_SEE-v1/%j-job.err # 指定错误输出的格式
